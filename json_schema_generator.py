...
class json_schema_generator_ui:
    ...
    def path_and_file_execution(self, path):
        try:
            ...
            messagebox.showerror("Error", "The data_descriptor is not properly included")
    ...
    def time_schema_generator(self, schema, key):
        ...
        schema["properties"][key] = {}
        schema["properties"][key]["type"] = "string"
        schema["properties"][key]["format"] = "time"
    ...
    def aggregation_checker(self, schema, key, time_series_list):
        ...
        try:
            ...
            for key in self.data_descriptor.keys():
                ...
                if key not in ["@context", "type", "dataDescriptorLabel","dataDescriptorlabel", "description"]:
                    ...
                    elif self.property_type(key) == "time":
                        schema = self.time_schema_generator(schema, key)
