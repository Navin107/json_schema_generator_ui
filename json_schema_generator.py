...
class json_schema_generator_ui:
    ...
    def verify_url(self):
        ...
        if not self.new_set: 
            ...
            self.execute_url(json_array)
            
    def execute_url(self, json_array):
        ...
        for i in self.new_set:
            ...
            try:
                ...
                if response:
                    ...
                    json_object = self.fetch_data(data)
    ...
    def fetch_data(self, data, path=None):
        json_object = None
        ...
        if type(data)==list:
            ...
            for data_element in data:
                ...
                if data_element.get("dataDescriptor","") == "" and path:
                    messagebox.showerror("Error", "The file  in the path - {} - doesnt have data descriptor", path)

                elif data_element.get("dataDescriptor","") == "" and not path:
                    messagebox.showerror("Error", "The url doesnt have data descriptor")
            ...
            if data.get("dataDescriptor","") == "" and path:
                ...
                messagebox.showerror("Error", "The the url doesnt have data descriptor")
